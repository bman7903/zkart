...
<div id="database" class="modalPage"><div>
  <a href="#confp" title="Close" class="close">&lt;</a>
  <h2>Database Box</h2>
  <p>This is a sample modal box that can be created using the powers of CSS3.</p>
  <p>You could do a lot of things here like have a pop-up ad that shows when your></p>
</div></div>
...
<div id="userz" class="modalPage"><div>
  ...
  </select>      <a id="plusmin"  href="#plusmin"><div class="plusmin"></div></a>
...
<div id="confp" class="modalPage"><div>
  <a href="#close" title="Close" class="close">X</a><br><center>
...
<div id="pntp" class="modalPage"><div>
  <a href="#confp" title="Conf" class="close">X</a>
  <h2>Color Box</h2>
...
<div id="whlp" class="modalPage"><div>
  <a href="#pntp" title="Close" class="close">X</a>
  %s
...
<div id="plusmin" class="modalDialog"><div>
  <a href="#userz" title="Close" class="close">&lt;</a>
   <div class="i-l">
   <a href="#umit" onclick="fjava();"
   <input type="submit" class="styled-button-5"  id="newitem"  name="NEW"     value="NEW"    >
   <input type="submit" class="styled-button-5"  id="newitem"  name="RENAME"  value="RENAME" >
   <input type="submit" class="styled-button-5"  id="newitem"  name="COPY"    value="COPY"   >
   <input type="submit" class="styled-button-5"  id="newitem"  name="DELETE"  value="DELETE" ></a> </div></div></div>
...
<div id="umit" class="modalPopup"><div>
  <a href="#userz" title="Close" class="close">&lt;</a>
     ...
     <form action="#" method="post">
         &nbsp;<input type="text" />&nbsp;
         <input type="submit" class="styled-button-5"  id="newitem"  name="ucom"  value="Commit" />
         <input type="hidden" id="uref" />
      </form>
